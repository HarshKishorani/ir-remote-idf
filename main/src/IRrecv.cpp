...
/// @endcond
  ...
  void IRrecv::enableIRIn(const bool pullup)
  {
    ...
    // UPDATE : timerAlarmWrite(timer, MS_TO_USEC(params.timeout), ONCE);
    timerAlarm(timer, MS_TO_USEC(params.timeout), true, ONCE);
...
#endif // ESP8266
#if defined(ESP32)
    // UPDATE : timerAlarmDisable(timer);
                      ...
                      uint8_t max_skip, uint16_t noise_floor)
  {
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Serial.println("In IRrecv trying to decode all the protocols : ");
    // Print the raw buffer size
    Serial.print("Raw Data Length: ");
    Serial.println(results->rawlen);

    // Iterate through the raw buffer and print each value
    ...
    for (int i = 0; i < results->rawlen; i++)
    {
      ...
      Serial.print(i);
      Serial.print(": ");
      Serial.println(results->rawbuf[i], DEC); // Print as decimal
    }
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
